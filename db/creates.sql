...
CREATE TABLE section(
    ...
    se_type              VARCHAR(9)      NOT NULL    CHECK (se_type = 'mandalory' OR se_type = 'elective')  DEFAULT 'mandalory',
    se_ht                NUMERIC(2,2)    NOT NULL,
    se_hp                NUMERIC(2,2)    NOT NULL,
    se_hl                NUMERIC(2,2)    NOT NULL,
